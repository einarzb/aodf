...
export default class SettingsDateRow extends React.Component{
    ...
    constructor(){
        super()
        this.state = {isShowingDate:false, editedTOD:"00:00:00", editedDate:new Date(Date.now()), shownDate:new Date(Date.now())};
    }
            ...
            <FormRow>
                ...
                <CalendarPopup>
                   ...
                   {/* { <SmallerInput  mask={HOURS}
                        ...
                        />} */}
                        <TimePicker isOpen={false} onChange={(date)=>{this.onTODChange(date)}}/>
                    <ModalButtons>
