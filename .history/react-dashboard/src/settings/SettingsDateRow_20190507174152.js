                ...
                <CalendarPopup>
                  ...
                  <CalendarBG>
                    <Calendar   
                      ...
                      <ModalButtons>
                        <SSelect dropProps={{style:{zIndex:99999}}} onChange={(minute)=>{this.setState({editedTOD:`${editedTOD.split(':')[0]}:${minute}`})}} value={hours} options={MINUTES} />
                        <SSelect dropProps={{style:{zIndex:99999}}} onChange={(hour)=>{this.setState({editedTOD:`${hour}:${editedTOD.split(':')[1]}`})}} value={minutes} options={HOURS} />
