                ...
                <CalendarPopup>
                  ...
                  <CalendarBG>
                    <Calendar   
                      ...
                      <ModalButtons>
                       <SSelect dropProps={{style:{zIndex:99999}}} onChange={(e)=>{this.setState({editedTOD:`${e.target.value}:${minutes}`})}} value={hours} options={HOURS} />

                        <SSelect dropProps={{style:{zIndex:99999}}} onChange={(e)=>{this.setState({editedTOD:`${hours}:${e.target.value}`})}} value={minutes} options={MINUTES} />
