                ...
                <CalendarPopup>
                  ...
                  <CalendarBG>
                    <Calendar   
                      ...
                      <ModalButtons>
                       <SSelect dropProps={{style:{zIndex:99999}}} onChange={({option})=>{
                         this.setState({editedTOD:`${option}:${minutes}`})}
                         } value={hours} options={HOURS} />

                        <SSelect dropProps={{style:{zIndex:99999}}} onChange={({option})=>{this.setState({editedTOD:`${hours}:${option}`})}} value={minutes} options={MINUTES} />
                  ...
                  :
                  <CalendarBG>
                    <Heading level={3}>{`Confirm new machine date`}</Heading>
      
                    <Heading color={'red'} level={4}>{editedDate.toDateString()}<br/> {editedTOD} </Heading>
