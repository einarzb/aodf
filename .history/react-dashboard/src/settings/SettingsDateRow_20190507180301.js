            ...
            <FormRow>
                ...
                <CalendarPopup>
                    ...
                    <Calendar   
                      ...
                      <ModalButtons>
                       <SSelect dropProps={{style:{zIndex:99999}}} onChange={({option})=>{
                         ...
                         } value={padHourInt(hours)} options={HOURS} />

                        <SSelect dropProps={{style:{zIndex:99999}}} onChange={({option})=>{this.setState({editedTOD:`${hours}:${option}`})}} value={padHourInt(minutes)} options={MINUTES} />
                  ...
                  <CalendarBG>
                    ...
                    <Heading color={'red'} level={3}>{editedDate.toDateString()}<br/> {editedTOD} </Heading>
