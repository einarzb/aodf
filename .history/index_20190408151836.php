...
<link href="react-dashboard/build/static/css/main.a68d4b31.chunk.css" rel="stylesheet">
...
<?php require_once 'sysinfo_display.php';?>
    <div id="main">
        <div id="mainmenu">
            ...
            <br/>
            <input id="test" <?php if(isset($_GET["param"])&&($_GET["param"]=="test"))echo 'class="selectedtab"';?>  name="reset_ms" type="button" value="Machine Settings" onclick="window.location.href='index.php?param=test'"/>
            <br/>
        </div>
        <div id="content">
<?php
...
<script src="react-dashboard/build/static/js/main.a5284679.chunk.js"></script>   
<script src="react-dashboard/build/static/js/2.ee1b408sdsdsd.chunk.js"></script>   
</body>
</html>
